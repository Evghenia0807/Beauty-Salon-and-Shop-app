...
class ButtonWithShadow: UIView {
    ...
    init(title: String, width: Int, height: Int, titleSize: CGFloat? = nil, goToIdentifier: String? = nil, onTap: (() -> Void)? = nil) {
        self.title = title
        self.width = width
        self.height = height
    ...
    @objc func buttonPressed(){
        ...
        if let goToIdentifier = goToIdentifier, let controller = findVC() {
